package Books.Eckel_AtomicScala.functions.OverridingMethods

/**
  *
  */
object Exercise3_TripOverride {
     ...
     class AirplaneTrip(origin:String, dest:String, startDate:String, endDate:String,
          ...
          override def toString: String = {
               super.toString + s", we watched $flightMovie"
          }
     }
     ...
     def main(args: Array[String]) {
          ...
          println("air: " + a)
          assert(a.toString == "From Detroit to London: 9/1/1939 to 10/31/1939, we watched Superman")
